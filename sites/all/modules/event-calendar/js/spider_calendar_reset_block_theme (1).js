...
function spider_calendar_reset_block_theme_5() {
  if (confirm(Drupal.t('Do you really whant to reset theme?'))) {
    ...
    document.getElementById("edit-cell-text-color-events").color.fromString("FFFFFF");
    document.getElementById("edit-cell-text-color-selected-events").color.fromString("FFFFFF");
    document.getElementById("edit-cell-bgcolor-events").color.fromString("585858");
    document.getElementById("edit-cell-bgcolor-selected-events").color.fromString("0A0A2A");
    document.getElementById("edit-event-title-color").color.fromString("FFFFFF");
    document.getElementById("edit-cur-day-cell-border-color").color.fromString("0A0A2A");
    document.getElementById("edit-selected-day-cell-border-color").color.fromString("FFFFFF");
    document.getElementById("edit-cell-border-color").color.fromString("000000");
    document.getElementById("edit-all-days-border").value = "0";
    document.getElementById("edit-sundays-tcolor").color.fromString("0A0A2A");
    document.getElementById("edit-sundays-cell-bgcolor").color.fromString("FFFFFF");
    document.getElementById("edit-sundays-fcolor").value = "14";
    document.getElementById("edit-days-fsize").value = "12";
    document.getElementById("edit-time-in-cell-1").checked = false;
    document.getElementById("edit-time-in-cell-0").checked = true;
    document.getElementById("edit-header-heidht").value = "70";
    document.getElementById("edit-header-bgcolor").color.fromString("0A0A2A");
    document.getElementById("edit-year-font-size").value = "18";
    ...
    // document.getElementById("edit-arrow-bgcolor-popup").color.fromString("585858");
    // document.getElementById("edit-arrow-color-popup").color.fromString("FFFFFF");
    // document.getElementById("edit-popup-bgcolor").color.fromString("0A0A2A");
