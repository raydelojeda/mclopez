  ...
  var head = document.getElementsByTagName('head')[0],
    ...
    rules = document.createTextNode(
      ...
      '#bigcalendar .cala_arrow a:link, #bigcalendar .cala_arrow a:visited{text-decoration:none;background:none;font-size:' + arrow_size + 'px; }' +
        ...
        '#bigcalendar .week_days {font-size:' + weekdays_font_size + 'px;font-family:one_trick_tony}' +
        ...
        '#bigcalendar .calfont_year {font-family:one_trick_tony;font-size:24px;font-weight:bold;color:' + text_color_year + ';}' +
